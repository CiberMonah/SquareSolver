...
/// \brief Function to print instructions use this function to explain user how to enter numbers
/// \param <input> void
/// \param <output> void
void print_instructions(void) {
    printf("# Enter in a row, separated by spaces, the coefficients of the quadratic equation of the form: ax^2 + bx + c = 0\n");
}
/// \brief Function to input coefficiens of square equation
/*!
...
/// \brief Function to clean buffer
/// \param void
/// \param void
...
/// \brief Function output info about creator
/// \param void
/// \param void
void greeting(void) {
...
/// \brief Function to avoid errors in reading from file
/*!
...
/// \brief Function to read tests from defined file and put them to array by pointer
/*!
    Returns number of all tests program had read
    \code
